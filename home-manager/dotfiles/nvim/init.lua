...
-- [[ Bootstrap Main Configuration Components ]]
require('ravenousByte.core.options')
require('ravenousByte.core.keymaps')
require('ravenousByte.core.autocommands')
...
require('lazy').setup({
  ...
  -- If you prefer to call `setup` explicitly, use:-- [[ Basic Autocommands ]]
--  See `:help lua-guide-autocommands`
  ...
  -- Java LSP config - This simplifies the "handshake" between nvim and jdtls
  {
    'nvim-java/nvim-java',
